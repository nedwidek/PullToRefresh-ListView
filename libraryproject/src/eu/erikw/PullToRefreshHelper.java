...
public class PullToRefreshHelper {
    ...
    public PullToRefreshHelper(PullToRefreshExpandableListView listView) {
    	this.listView = listView;
    }
	...
	protected void init(){
        ...
        pullToRefreshText = listView.getContext().getString(R.string.ptr_pull_to_refresh);
        releaseToRefreshText = listView.getContext().getString(R.string.ptr_release_to_refresh);
        refreshingText = listView.getContext().getString(R.string.ptr_refreshing);
        lastUpdatedText = listView.getContext().getString(R.string.ptr_last_updated);
        ...
        scrollbarEnabled = listView.isVerticalScrollBarEnabled();
	...
	public boolean onTouchEvent(MotionEvent event){
        if(lockScrollWhileRefreshing
                && (state == State.REFRESHING || listView.getAnimation() != null && !listView.getAnimation().hasEnded())){
            return true;
        }

        switch(event.getAction()){
            case MotionEvent.ACTION_DOWN:
                if(listView.getFirstVisiblePosition() == 0) previousY = event.getY();
                else previousY = -1;
                break;

            case MotionEvent.ACTION_UP:
                if(previousY != -1 && (state == State.RELEASE_TO_REFRESH ||listView. getFirstVisiblePosition() == 0)){
                    switch(state){
	...
	protected void bounceBackHeader(){
        ...
        listView.startAnimation(bounceAnimation);
    }
	...
	protected void resetHeader(){
        ...
        if(listView.getAnimation() != null && !listView.getAnimation().hasEnded()){
    ...
    protected void setUiRefreshing(){
	...
	private class HeaderAnimationListener implements AnimationListener{
        ...
        public void onAnimationStart(Animation animation){
            ...
            height = lp.height;
            lp.height = listView.getHeight() - translation;
